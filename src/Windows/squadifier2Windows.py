...
# Form implementation generated from reading ui file 'squadifier2Windows.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.msgLbl.setGeometry(QtCore.QRect(680, 340, 301, 71))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(18)
        ...
        self.aggiungiBtn.clicked.connect(self.actionaggiungi.trigger) # type: ignore
        self.generaBtn.clicked.connect(self.actiongenera.trigger) # type: ignore
